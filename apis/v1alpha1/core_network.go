...
// +kubebuilder:printcolumn:name="CORENETWORKID",type=string,priority=0,JSONPath=`.status.coreNetworkID`
// +kubebuilder:printcolumn:name="GLOBALNETWORK",type=string,priority=1,JSONPath=`.spec.globalNetworkID`
