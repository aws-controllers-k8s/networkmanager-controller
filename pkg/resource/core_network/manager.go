...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=corenetworks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=corenetworks/status,verbs=get;update;patch
