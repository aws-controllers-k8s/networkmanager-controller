...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=vpcattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=vpcattachments/status,verbs=get;update;patch
