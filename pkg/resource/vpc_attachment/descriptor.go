...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/VPCAttachment"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vpcattachments")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VPCAttachment{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCAttachment),
	}
}
