...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=corenetworkpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=corenetworkpolicies/status,verbs=get;update;patch
