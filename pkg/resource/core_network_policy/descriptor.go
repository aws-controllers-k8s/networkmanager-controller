...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/CoreNetworkPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("corenetworkpolicies")
	GroupKind            = metav1.GroupKind{
		Group: "networkmanager.services.k8s.aws",
		Kind:  "CoreNetworkPolicy",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CoreNetworkPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CoreNetworkPolicy),
	}
}
