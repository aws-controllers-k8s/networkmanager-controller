...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/ConnectAttachment"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("connectattachments")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ConnectAttachment{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ConnectAttachment),
	}
}
