...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=connectattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=connectattachments/status,verbs=get;update;patch
