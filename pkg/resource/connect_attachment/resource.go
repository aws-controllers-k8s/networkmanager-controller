...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.AttachmentID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["attachmentID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: attachmentID"))
	}
	r.ko.Status.AttachmentID = &primaryKey
