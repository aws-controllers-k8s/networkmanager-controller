...
// customDeleteConnectAttachment deletes a ConnectAttachment using the shared
// DeleteAttachment API.
func (rm *resourceManager) customDeleteConnectAttachment(
	ctx context.Context,
	r *resource,
) (*resource, error) {
...
func (rm *resourceManager) syncTopLevelStatus(ko *svcapitypes.ConnectAttachment) {
...
var _ = &svcapitypes.ConnectAttachment{}
