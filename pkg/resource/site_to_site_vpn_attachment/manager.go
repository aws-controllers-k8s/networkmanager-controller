...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=sitetositevpnattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=sitetositevpnattachments/status,verbs=get;update;patch
