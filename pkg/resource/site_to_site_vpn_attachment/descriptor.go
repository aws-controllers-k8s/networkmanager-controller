...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/SiteToSiteVPNAttachment"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("sitetositevpnattachments")
	GroupKind            = metav1.GroupKind{
		Group: "networkmanager.services.k8s.aws",
		Kind:  "SiteToSiteVPNAttachment",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.SiteToSiteVPNAttachment{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.SiteToSiteVPNAttachment),
	}
}
