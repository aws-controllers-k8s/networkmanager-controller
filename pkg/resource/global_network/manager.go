...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=globalnetworks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=globalnetworks/status,verbs=get;update;patch
