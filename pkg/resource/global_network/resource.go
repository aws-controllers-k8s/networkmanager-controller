...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.GlobalNetworkID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["globalNetworkID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: globalNetworkID"))
	}
	r.ko.Status.GlobalNetworkID = &f0
