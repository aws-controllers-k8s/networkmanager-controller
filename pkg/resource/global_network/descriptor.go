...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/GlobalNetwork"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("globalnetworks")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.GlobalNetwork{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.GlobalNetwork),
	}
}
