...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/ConnectPeer"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("connectpeers")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ConnectPeer{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ConnectPeer),
	}
}
