...
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=connectpeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkmanager.services.k8s.aws,resources=connectpeers/status,verbs=get;update;patch
