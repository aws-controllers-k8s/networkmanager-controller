...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.ConnectPeerID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["connectPeerID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: connectPeerID"))
	}
	r.ko.Status.ConnectPeerID = &f0
